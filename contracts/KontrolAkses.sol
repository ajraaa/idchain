...
contract KontrolAkses {
    ...
    modifier onlyKalurahan() {
        require(kalurahan[msg.sender], "Hanya petugas kalurahan yang diizinkan melakukan ini.");
        _;
    }

    modifier onlyDukcapil() {
        require(dukcapil[msg.sender], "Hanya petugas dukcapil yang diizinkan melakukan ini.");
        _;
    }
